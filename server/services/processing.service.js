 ...
 *
 * Note: callers should fire-and-forget (no await) for MVP in-process processing.
 */
export const processVideo = async (videoDoc, rawPath) => {
  ...
  try {
    ...
    videoDoc.processingError = err.message;
    await videoDoc.save().catch((saveErr) => {
